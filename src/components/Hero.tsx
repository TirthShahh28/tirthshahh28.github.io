...
export default function Hero() {
  return (
    ...
    >
      <div className="max-w-4xl mx-auto flex flex-col-reverse md:flex-row items-center gap-12 md:gap-16">
        <div className="flex-1 text-center md:text-left">
          ...
          >
            ...
            scalable data workflows. Currently seeking full-time AI Engineering
            roles.
          </motion.p>
